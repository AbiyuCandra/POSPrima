...
public class Dashboard_tab extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    Dashboard_Library dashboard_library = new Dashboard_Library();
                    return dashboard_library;
                case 1:
                    Dashboard_Barcode dashboard_barcode = new Dashboard_Barcode();
                    return dashboard_barcode;
            }
            return null;
        }
